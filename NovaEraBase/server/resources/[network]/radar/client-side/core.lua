...
CreateThread(function()
	while true do
		...
		if IsPedInAnyPoliceVehicle(Ped) and LocalPlayer["state"]["PMERJ"] or LocalPlayer["state"]["PCERJ"] or LocalPlayer["state"]["PRF"] or LocalPlayer["state"]["BOPE"] or LocalPlayer["state"]["RECOM"] or LocalPlayer["state"]["BPCHQ"] or LocalPlayer["state"]["EX"] then
			if policeRadar then
...
RegisterCommand("toggleFreeze", function()
	local Ped = PlayerPedId()
	if IsPedInAnyPoliceVehicle(Ped) and LocalPlayer["state"]["PMERJ"] or LocalPlayer["state"]["PCERJ"] or LocalPlayer["state"]["PRF"] or LocalPlayer["state"]["BOPE"] or LocalPlayer["state"]["RECOM"] or LocalPlayer["state"]["BPCHQ"] or LocalPlayer["state"]["EX"] and not IsPauseMenuActive() then
