const IMAGE_BASE_URL = "http://localhost/skinshop"; // Diretório para puxar as imagens
...
`,
  ...
  background: rgba(52, 152, 235, 0.55);
  border: 0.0625rem solid rgb(52, 152, 235);
  border-radius: 0.4375rem;
`,
			su = Ie.img`
  border-radius: 0.4375rem;
...
`, Ie.div`
  ...
  &:hover {
	...
	background: rgba(52, 152, 235, 0.4);
	border: 0.0625rem solid rgb(52, 152, 235);
  }
`),
			pu = Ie.div`
...
`;
		...
		function Qu() {
			...
			const b = e => {
				...
				o(Object.assign({}, a, {
					current: Object.assign({}, a.current, {
			...
			return e.createElement($u, {
				...
				price: y(n),
				type: g(n),
				image: `${IMAGE_BASE_URL}/${r.imageId}/${a.isMale ? "male" : "Female"}/${n + a.max.min}_0.png`,
				onClick: () => {
					("vip" !== g(n) || a.isVip) && (e => {
						const n = a.max.min + e;
						Ve("updateDataOfCategory", {
			...
			}), a.current.texture + 0, e.createElement(Tu, {
				style: {
