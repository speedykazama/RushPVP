...
function Ne() {
  ...
  do {
    ...
    for (D(null), W.length = 0, Y = 0; de.length; ) {
      de.pop()()
    }
...
function De(e, t, n, r) {
  ...
  r ||
    ie(() => {
      ...
      e.$$.on_destroy ? e.$$.on_destroy.push(...i) : U(i)
      e.$$.on_mount = []
    })
  s.forEach(ie)
}
...
function Je(e, t) {
  e.$$.dirty[0] === -1 && (W.push(e), qe(), e.$$.dirty.fill(0))
...
function Xe(e, t, n, r, o, s, i, d = [-1]) {
  ...
  if (
    ((a.ctx = n
      ? n(e, t.props || {}, (h, u, ...w) => {
          ...
          return (
            a.ctx &&
              o(a.ctx[h], (a.ctx[h] = y)) &&
              (!a.skip_bound && a.bound[h] && a.bound[h](y), m && Je(e, h)),
            u
          )
        })
      : []),
    ...
    (m = true),
    U(a.before_update),
    (a.fragment = r ? r(a.ctx) : false),
    t.target)
  ) {
    if (t.hydrate) {
      const h = Ke(t.target)
      a.fragment && a.fragment.l(h)
      h.forEach(H)
    } else {
...
class Ye {
  ...
  $set(t) {
    this.$$set &&
      !He(t) &&
      ((this.$$.skip_bound = true), this.$$set(t), (this.$$.skip_bound = false))
  }
}
var ae = { exports: {} },
...
b.prototype.emit = function (t) {
  ...
  if (typeof f == 'function') {
    ...
    for (var a = f.length, m = Re(f, a), r = 0; r < a; ++r) {
      pe(m[r], this, n)
    }
  }
  return true
...
b.prototype.addListener = function (t, n) {
  return Pe(this, t, n, false)
}
b.prototype.on = b.prototype.addListener
b.prototype.prependListener = function (t, n) {
  return Pe(this, t, n, true)
}
function tt() {
  if (!this.fired) {
    return (
...
b.prototype.removeListener = function (t, n) {
  var r, o, s, i, d
  if ((re(n), (o = this._events), o === void 0)) {
    return this
  }
  if (((r = o[t]), r === void 0)) {
    return this
  ...
  if (r === n || r.listener === n) {
    ...
    if (typeof r != 'function') {
      ...
      s === 0 ? r.shift() : nt(r, s)
      r.length === 1 && (o[t] = r[0])
      o.removeListener !== void 0 && this.emit('removeListener', t, d || n)
    }
  }
  return this
}
...
b.prototype.listeners = function (t) {
  return Se(this, t, true)
}
b.prototype.rawListeners = function (t) {
  return Se(this, t, false)
}
...
function it(e, t) {
  le.on(e, t)
  Ze(() => le.removeListener(e, t))
}
async function Z(e, t) {
  var i
  const n =
      (i = window.GetParentResourceName) == null ? void 0 : i.call(window),
    r = new URL(e, `http://${n}/`),
    o = {
      method: 'POST',
...
function _e(e) {
  let t,
    ...
    P,
    K,
    S = Object.entries(e[3][e[2]].items),
    L = []
  ...
  return {
    c() {
      ...
      E = v('div')
      p = v('button')
      p.textContent = 'Cancelar'
      x = C()
      M = v('button')
      M.textContent = 'Salvar'
      l(
        o,
        'class',
        'w-[4.5rem] h-[4.5rem] grid place-items-center bg-black/[0.18] rounded svelte-1vyyw8w'
      )
      R(o, 'selected', e[2] === 'appearance')
      l(
        i,
        'class',
        'w-[4.5rem] h-[4.5rem] grid place-items-center bg-black/[0.18] rounded svelte-1vyyw8w'
      )
      R(i, 'selected', e[2] === 'hair')
      l(
        f,
        'class',
        'w-[4.5rem] h-[4.5rem] grid place-items-center bg-black/[0.18] rounded svelte-1vyyw8w'
      )
      R(f, 'selected', e[2] === 'beard')
      l(
        m,
        'class',
        'w-[4.5rem] h-[4.5rem] grid place-items-center bg-black/[0.18] rounded svelte-1vyyw8w'
      )
      R(m, 'selected', e[2] === 'makeup')
      l(
        u,
        'class',
        'w-[4.5rem] h-[4.5rem] grid place-items-center bg-black/[0.18] rounded svelte-1vyyw8w'
      )
      R(u, 'selected', e[2] === 'lipstick')
      l(
        r,
        'class',
        'w-full flex flex-row items-center justify-center gap-[0.9375rem]'
      )
      l(A, 'class', 'text-2xl font-semibold tracking-wider')
      l(
        j,
        'class',
        'h-[36.0625rem] grid place-content-start space-y-4 overflow-hidden overflow-y-auto no-scrollbar'
      )
      l(y, 'class', 'flex flex-col items-start space-y-1')
      l(
        p,
        'class',
        'h-14 flex-1 text-cr font-normal tracking-wider hover:bg-black/20 uppercase'
      )
      l(
        M,
        'class',
      ...
      l(
        E,
        'class',
        'w-[26.25rem] h-14 flex flex-row bg-black/60 overflow-hidden rounded-[0.4375rem]'
      )
      l(
        n,
        'class',
        'w-[31.8125rem] h-[54.625rem] ml-20 relative flex flex-col items-center justify-center space-y-16'
      )
      l(
        t,
        'class',
        'fixed inset-0 grid items-center justify-start text-white font-poppins ' +
          (location.port === '5173' && 'bg-black/50') +
          " bg-[url('./assets/bg_cr.png')] bg-no-repeat bg-center bg-cover select-none svelte-1vyyw8w"
      )
    },
    m(g, O) {
      F(g, t, O)
    ...
    p(g, O) {
      if (
        (O & 4 && R(o, 'selected', g[2] === 'appearance'),
        O & 4 && R(i, 'selected', g[2] === 'hair'),
        O & 4 && R(f, 'selected', g[2] === 'beard'),
        O & 4 && R(m, 'selected', g[2] === 'makeup'),
        O & 4 && R(u, 'selected', g[2] === 'lipstick'),
        O & 12 && T !== (T = g[3][g[2]].title + '') && ne(B, T),
        O & 46)
      ) {
...
function ye(e) {
  ...
  return {
    c() {
      ...
      M = $('svg')
      P = $('path')
      l(r, 'class', 'text-base text-white/50 font-normal tracking-wider')
      l(d, 'class', 'text-base text-white/70 font-normal tracking-wider')
      l(n, 'class', 'flex flex-row items-center justify-between')
      l(y, 'd', 'M7 0.999999L0.999999 7L7 13')
      l(y, 'stroke', '#f50000')
      l(y, 'stroke-width', '2')
      l(y, 'stroke-linecap', 'round')
      l(y, 'stroke-linejoin', 'round')
      l(w, 'class', 'w-2 h-[0.875rem] grid place-items-center')
      l(w, 'viewBox', '0 0 8 14')
      l(w, 'fill', 'none')
      l(w, 'xmlns', 'http://www.w3.org/2000/svg')
      u.disabled = A = e[1][e[22].key] <= e[22].min
      l(u, 'class', 'w-12 h-14 grid place-items-center hover:bg-cr/10')
      l(_, 'type', 'range')
      l(_, 'min', (j = e[22].min))
      l(_, 'max', (I = e[22].max))
      l(_, 'step', (E = e[22].max < 1 ? '0.01' : e[22].step || '1'))
      l(
        _,
        'class',
        'w-[17.5rem] h-1 bg-cr/10 outline-none appearance-none rounded svelte-1vyyw8w'
      )
      l(B, 'class', 'w-[20.25rem] h-14 grid place-items-center')
      l(P, 'd', 'M1 13L7 7L1 1')
      l(P, 'stroke', '#f50000')
      l(P, 'stroke-width', '2')
      l(P, 'stroke-linecap', 'round')
      l(P, 'stroke-linejoin', 'round')
      l(M, 'class', 'w-2 h-[0.875rem] grid place-items-center')
      l(M, 'viewBox', '0 0 8 14')
      l(M, 'fill', 'none')
      l(M, 'xmlns', 'http://www.w3.org/2000/svg')
      x.disabled = K = e[1][e[22].key] >= e[22].max
      l(x, 'class', 'w-12 h-14 grid place-items-center hover:bg-cr/10')
      l(
        h,
        'class',
        'flex flex-row items-center bg-black/[0.58] overflow-hidden rounded-[0.4375rem]'
      )
      l(t, 'class', 'w-[26.25rem] h-[5.3125rem] flex flex-col space-y-2')
    },
    m(z, V) {
      F(z, t, V)
      c(t, n)
    ...
    p(z, V) {
      e = z
      V & 12 && o !== (o = e[22].text + '') && ne(s, o)
      V & 14 && f !== (f = e[1][e[22].key].toFixed(1) + '') && ne(a, f)
      V & 14 && A !== (A = e[1][e[22].key] <= e[22].min) && (u.disabled = A)
      V & 12 && j !== (j = e[22].min) && l(_, 'min', j)
      V & 12 && I !== (I = e[22].max) && l(_, 'max', I)
      V & 12 &&
        E !== (E = e[22].max < 1 ? '0.01' : e[22].step || '1') &&
        l(_, 'step', E)
      V & 14 && fe(_, e[1][e[22].key])
      V & 14 && K !== (K = e[1][e[22].key] >= e[22].max) && (x.disabled = K)
    },
    d(z) {
      z && H(t)
      S = false
...
function we(e) {
  ...
  return {
    c() {
      ...
      d = C()
      l(n, 'class', 'text-base text-white/50 font-normal tracking-wider')
      l(
        i,
        'class',
        'w-[26.25rem] h-[13.375rem] p-6 grid grid-cols-12 place-items-center bg-black/[0.58] overflow-hidden rounded-[0.4375rem]'
      )
      l(t, 'class', 'flex flex-col space-y-2')
    },
    m(m, h) {
      F(m, t, h)
      c(t, n)
...
function ke(e) {
  ...
  return {
    c() {
      t = $('svg')
      n = $('path')
      l(n, 'd', 'M13 1.5L4.75 9.75L1 6')
      l(n, 'stroke', 'white')
      l(n, 'stroke-opacity', '0.5')
      l(n, 'stroke-width', '1.5')
      l(n, 'stroke-linecap', 'round')
      l(n, 'stroke-linejoin', 'round')
      l(t, 'class', 'w-[0.875rem] h-[0.6875rem]')
      l(t, 'viewBox', '0 0 14 11')
      l(t, 'fill', 'none')
...
function Le(e) {
  ...
  return {
    c() {
      ...
      s && s.c()
      n = C()
      ue(t, 'background', e[25])
      l(
        t,
        'class',
        'w-[1.375rem] h-[1.375rem] grid place-items-center border-[0.5px] border-white/50 rounded-[0.1875rem]'
      )
    },
    m(d, f) {
      F(d, t, f)
...
function xe(e) {
  let t,
    n,
    r = e[22].color === false && ye(e),
    o = e[22].color !== false && we(e)
  return {
    c() {
      r && r.c()
      t = C()
    ...
    p(s, i) {
      s[22].color === false
        ? r
          ? r.p(s, i)
          : ((r = ye(s)), r.c(), r.m(t.parentNode, t))
        : r && (r.d(1), (r = null))
      s[22].color !== false
        ? o
          ? o.p(s, i)
          : ((o = we(s)), o.c(), o.m(n.parentNode, n))
        : o && (o.d(1), (o = null))
    },
    d(s) {
      r && r.d(s)
...
function at(e, t, n) {
  ...
  window.addEventListener('keydown', (p) => {
    p.code === 'KeyA' && Z('Rotate', 'Left')
    p.code === 'KeyD' && Z('Rotate', 'Right')
    p.code === 'Escape' && (Z('Cancel'), n(0, (d = false)))
  })
  function f(p) {
    n(2, (o = p))
  }
  ...
  return (
          ...
          (i = {
            ...
            beard: {
              ...
              items: [
                ...
                {
                  key: 46,
                  text: "Intensidade Pelo Corporal",
                  min: 0,
                  max: .99,
                  step: .01,
                  color: !1
    ...
    [d, s, o, i, f, a, r, m, h, u, w, y, A, T, B, _, j, I, E]
  )
}
class ct extends Ye {
  constructor(t) {
...
new ct({ target: document.getElementById('app') })
