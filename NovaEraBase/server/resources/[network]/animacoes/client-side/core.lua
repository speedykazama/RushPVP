...
local animacoes = {
	...
	["mecanico6"] = { dict = "anim@amb@clubhouse@tutorial@bkr_tut_ig3@", anim = "machinic_loop_mechandplayer", walk = true, loop = true },
--- NEWS ANIMS ARMAS
	["wpose"] = { dict = "anim@male@aim_weapon", anim = "aim_weapon_clip", walk = true, loop = true },
	["wpose1"] = { dict = "anim@male@holding_weapon_2", anim ="holding_weapon_2_clip", walk = true, loop = true },
	["wpose2"] = { dict = "anim@male@holding_weapon_kneel", anim = "anim@male@holding_weapon_kneel_clip", walk = true, loop = true },
	["wpose3"] = { dict = "anim@male@holding_weapon_nvg", anim = "holding_weapon_nvg_clip", walk = true, loop = true },
	["wpose4"] = { dict = "anim@male@holding_weapon_nvg_2", anim ="holding_weapon_nvg_2_clip", walk = true, loop = true },
	["wpose5"] = { dict = "anim@male@hug_weapon", anim = "hug_weapon_clip", walk = true, loop = true },
	["wpose6"] = { dict = "anim@male@hug_weapon_2", anim = "hug_weapon_2_clip", walk = true, loop = true },
	["wpose7"] = { dict = "anim@male@pose_weapon", anim = "pose_weapon_clip", walk = true, loop = true },
	["wpose8"] = { dict = "anim@male@pose_weapon_2", anim = "pose_weapon_2_clip", walk = true, loop = true },
	["wpose9"] = { dict = "anim@male@pose_weapon_3", anim = "pose_weapon_3_clip", walk = true, loop = true },
	["wpose10"] = { dict = "anim@male@aim_weapon", anim = "aim_weapon_clip", walk = true, loop = true },
	["wpose11"] = { dict = "anim@male@preaim_weapon", anim = "preaim_weapon_clip", walk = true, loop = true },
	["wpose12"] = { dict = "anim@male@run_weapon", anim = "run_weapon_clip", walk = true, loop = true },
	["wpose13"] = { dict = "anim@male@tactical_kneel", anim = "tactical_kneel_clip", walk = true, loop = true },
	["wpose14"] = { dict = "anim@male@holding_vest", anim = "holding_vest_clip", walk = true, loop = true },
	["wpose15"] = { dict = "anim@holding_side_vest", anim = "holding_side_vest_clip", walk = true, loop = true },
	["wpose16"] = { dict = "anim@holding_siege_vest_side", anim = "holding_siege_vest_side_clip", walk = true, loop = true },
	["wpose17"] = { dict = "anim@male@holding_vest_2", anim = "holding_vest_2_clip", walk = true, loop = true },
	["wpose18"] = { dict = "anim@male@holding_vest_siege", anim = "holding_vest_siege_clip", walk = true, loop = true },
	["wpose19"] = { dict = "anim@male@holding_vest_siege_2", anim = "holding_vest_siege_2_clip", walk = true, loop = true },
	["wpose20"] = { dict = "anim@radio_left", anim = "radio_left_clip", walk = true, loop = true },
	["wpose21"] = { dict = "anim@male@holding_radio", anim = "holding_radio_clip", walk = true, loop = true },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- EMOTES
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("emotes",function(Name)
	...
	if animacoes[Name] and GetEntityHealth(Ped) > 100 and not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Buttons"] and not LocalPlayer["state"]["Cancel"] and not LocalPlayer["state"]["Handcuff"] then
	...
	elseif Name:sub(1, 6) == "dancar" and tonumber(Name:sub(7)) and IsPedArmed(Ped, 7) then
		vRP.playAnim(animacoes[Name]["walk"], {animacoes[Name]["dict"], animacoes[Name]["anim"]}, animacoes[Name]["loop"])
	end
end)
