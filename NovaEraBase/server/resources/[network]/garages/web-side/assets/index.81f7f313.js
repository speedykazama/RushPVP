const wS = "http://localhost/veiculos/"; // Diretório para puxar as imagens dos veículos
...
`,
  jc = me.button` 
    ...
    color: ${(e) =>
      e.city ? "rgba(34, 232, 235, 1)" : "rgba(52, 152, 235, 1)"};
...
var O0 = "./assets/background.485be87f1.png",
...
`,
  ...
  aS = me.button` 
    ...
    background: ${(e) =>
      e.city ? "rgba(34, 232, 235, 0.2)" : "rgba(52, 152, 235, 0.2)"};
    ...
    svg {
        ...
        stroke: ${(e) =>
          e.city ? "rgba(34, 232, 235, 0.6)" : "rgba(52, 152, 235, 0.6)"};
    }

    :hover {
        background: ${(e) =>
          e.city ? "rgba(34, 232, 235, 0.4)" : "rgba(52, 152, 235, 0.4)"};
