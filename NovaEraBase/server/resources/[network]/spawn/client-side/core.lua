...
AddEventHandler("spawn:Opened",function()
	...
	SetEntityHeading(Ped, SpawnCreatorCoords.w)
	SetEntityHealth(Ped, 101)
	SetPedArmour(Ped, 0)

	Camera = CreateCam("DEFAULT_SCRIPTED_CAMERA", true)
	SetCamCoord(Camera, SpawnCamCreatorCoords.x, SpawnCamCreatorCoords.y, SpawnCamCreatorCoords.z)
	RenderScriptCams(true, true, 0, true, true)
	SetCamRot(Camera, 0.0, 0.0, SpawnCamCreatorCoords.w, 2)
