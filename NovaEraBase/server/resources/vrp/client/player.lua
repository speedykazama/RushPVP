...
CreateThread(function()
	while true do
		...
		SetRunSprintMultiplierForPlayer(Pid, RunSpeedMultiplier or 1.0)
...
function ReloadCharacter(Pid,Ped)
	...
	SetAiWeaponDamageModifier(AiWeaponDamageModifier)
	...
	if MapNameModifier then
        AddTextEntry("FE_THDR_GTAO", MapTextName)
	end
	...
	for Weapon, Damage in pairs(WeaponDamageModifier) do
