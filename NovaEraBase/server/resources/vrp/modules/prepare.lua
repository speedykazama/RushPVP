...
vRP.Prepare("characters/getFines", "SELECT fines FROM characters WHERE id = @id")
...
vRP.Prepare("characters/CheckGun", "SELECT gun FROM characters WHERE id = @Passport")
...
vRP.Prepare("accounts/updatePremiumPlatina","UPDATE accounts SET premiumplatina = premiumplatina + 2592000 WHERE license = @license")
vRP.Prepare("accounts/setPremiumPlatina","UPDATE accounts SET premiumplatina = @premiumplatina WHERE license = @license")
vRP.Prepare("accounts/setPremiumOuro","UPDATE accounts SET premiumouro = @premiumouro WHERE license = @license")
vRP.Prepare("accounts/updatePremiumOuro","UPDATE accounts SET premiumouro = premiumouro + 2592000 WHERE license = @license")
vRP.Prepare("accounts/setPremiumPrata","UPDATE accounts SET premiumprata = @premiumprata WHERE license = @license")
vRP.Prepare("accounts/updatePremiumPrata","UPDATE accounts SET premiumprata = premiumprata + 2592000 WHERE license = @license")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PRISON
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("gunlicense/GetByUser","SELECT * FROM police_gunlicense WHERE user_id = @Passport ORDER BY portId DESC LIMIT 1")
-----------------------------------------------------------------------------------------------------------------------------------------
-- REPORTS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- CLEARTABLES
-----------------------------------------------------------------------------------------------------------------------------------------
vRP.Prepare("cleartables/Playerdata","DELETE FROM playerdata WHERE dvalue = '[]' OR dvalue = '{}'")
vRP.Prepare("cleartables/Entitydata","DELETE FROM entitydata WHERE dvalue = '[]' OR dvalue = '{}'")
-----------------------------------------------------------------------------------------------------------------------------------------
-- WAREHOUSE
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("propertys/Count", "SELECT COUNT(*) AS count FROM propertys WHERE Passport = @Passport")
...
CreateThread(function()
	vRP.Query("cleartables/Playerdata")
	vRP.Query("cleartables/Entitydata")
end)