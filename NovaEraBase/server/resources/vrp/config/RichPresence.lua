...
AddEventHandler("vRP:Active",function(Passport,Name)
	...
	SetDiscordAppId(1295208660687130765)
	SetDiscordRichPresenceAsset("RushPvP")
	SetRichPresence("#"..Passport.." "..Name)
	SetDiscordRichPresenceAssetSmall("rushpvp")
	SetDiscordRichPresenceAssetText("RushPvP")
	SetDiscordRichPresenceAssetSmallText("RushPvP")
