...
Locale.press_to_attach = 'Pressione para anexar'
Locale.press_to_detach = 'Solte todas as cordas'
Locale.vehicles_locked = 'Este veículo está trancado e, portanto, não pode ser rebocado'
